...
module.exports = function (current, versions, thresholds = {}) {
  return minimalByMajor(current, versions, thresholds.major || 0) ||
    minimalByMinor(current, versions, thresholds.minor || 0) ||
    minimalByPatch(current, versions, thresholds.patch || 0) ||
    null;
};
